class PhotoGallery{
    constructor(){
      this.API_KEY = 'qZWe2ZT3J0SLaIHHdfFUjxbvPXx3P5CmlOw92gfDQEgoDOn6WtJtoKPh';
    ...
    GenerateHTML(photos){
      photos.forEach((photo, index)=>{
        ...
        item.classList.add('item');
        item.innerHTML = `
          <img src="${photo.src.medium}" data-index="${index}">
          <h3>${photo.photographer}</h3>
        `;
        this.galleryDIv.appendChild(item);
        ...
        item.querySelector('img').addEventListener('click', () => {
          ...
          modal.querySelector('.prev').addEventListener('click', () => {
            ...
            modal.querySelector('img').src = photos[currentIndex].src.original;
          });
